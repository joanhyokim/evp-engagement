...
import com.liferay.evp.admin.model.FundClp;
import com.liferay.evp.admin.model.ProjectClp;
import com.liferay.evp.admin.model.VolunteerClp;
...
public class ClpSerializer {
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(VolunteerClp.class.getName())) {
			return translateInputVolunteer(oldModel);
		}
	...
	public static Object translateInputVolunteer(BaseModel<?> oldModel) {
		VolunteerClp oldClpModel = (VolunteerClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getVolunteerRemoteModel();
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.liferay.evp.admin.model.impl.FundImpl")) {
		...
		if (oldModelClassName.equals(
					"com.liferay.evp.admin.model.impl.ProjectImpl")) {
		...
		if (oldModelClassName.equals(
					"com.liferay.evp.admin.model.impl.VolunteerImpl")) {
			return translateOutputVolunteer(oldModel);
		}
		else if (oldModelClassName.endsWith("Clp")) {
			try {
				ClassLoader classLoader = ClpSerializer.class.getClassLoader();
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.liferay.evp.admin.NoSuchProjectException")) {
			return new com.liferay.evp.admin.NoSuchProjectException(throwable.getMessage(),
				throwable.getCause());
		}

		if (className.equals("com.liferay.evp.admin.NoSuchVolunteerException")) {
			return new com.liferay.evp.admin.NoSuchVolunteerException(throwable.getMessage(),
				throwable.getCause());
		}
	...
	public static Object translateOutputVolunteer(BaseModel<?> oldModel) {
		VolunteerClp newModel = new VolunteerClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setVolunteerRemoteModel(oldModel);
